...
object TaskMapper {
    ...
    fun Task.toEntity(timestampCreated: Long? = null, timestampUpdated: Long? = null): TaskEntity {
        return TaskEntity(
            id = id,
            title = title,
            description = description,
    ...
    fun Task.toDto(isoCreatedAt: String? = null, isoUpdatedAt: String? = null): TaskDto {
        return TaskDto(
            id = id,
            title = title,
